...
$favorites = new Favorites($_SESSION['FAVORITE_POSTS']);
...
?>
<div class="container">
    <a class="main-link" href="/favorites/">Открыть избранные статьи</a>
</div>
    <div class="container">
    <?php foreach ($categories as $category) { ?>
        <div id="category_<?php echo $category->getID(); ?>">
            <div>Всего статей в категории: <?= $category->getCount(); ?></div>
            <?php $favoritCount = $favorites->getCountByCategory($category->getID());?>
            <?php if ($favoritCount) { ?>
                <div>Избранных статей в категории: <?php echo $favoritCount; ?></div>
            <?php } ?>
            ...
            foreach ($posts as $post) {
                ...
                if (in_array($post->getID(), $favoriteIds)) {
                ...
                <article>
                    <a class="<?php echo $buttonClass; ?>"
                       href="/?<?php echo $buttonAction . '=' .  $post->getID(); ?>">
